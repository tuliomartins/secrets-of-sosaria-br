...
namespace Server.Items
{
	...
	public class ParalyzingBlow : WeaponAbility
	{
		...
		public static readonly TimeSpan PlayerFreezeDuration = TimeSpan.FromSeconds( 6.0 );
		public static readonly TimeSpan NPCFreezeDuration = TimeSpan.FromSeconds( 12.0 );

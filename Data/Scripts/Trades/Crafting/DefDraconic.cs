...
namespace Server.Engines.Craft
{
	public class DefDraconic : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( DragonArms ), "Scalemail", "scalemail arms", 66.2, 131.2, typeof( RedScales ), "Reptile Scales", 36, 1042081 );
			AddCraft( typeof( DragonChest ), "Scalemail", "scalemail tunic", 77.5, 142.5, typeof( RedScales ), "Reptile Scales", 50, 1042081 );
			AddCraft( typeof( DragonGloves ), "Scalemail", "scalemail gloves", 56.6, 121.6, typeof( RedScales ), "Reptile Scales", 24, 1042081 );
			AddCraft( typeof( DragonHelm ), "Scalemail", "scalemail helm", 61.4, 126.4, typeof( RedScales ), "Reptile Scales", 30, 1042081 );
			AddCraft( typeof( DragonLegs ), "Scalemail", "scalemail leggings", 69.4, 134.4, typeof( RedScales ), "Reptile Scales", 40, 1042081 );

			AddCraft( typeof( ScaledArms ), "Scaled Plate", "scaled arms", 72.8, 142.8, typeof( RedScales ), "Reptile Scales", 54, 1042081 );
			AddCraft( typeof( ScaledChest ), "Scaled Plate", "scaled chest", 75, 145, typeof( RedScales ), "Reptile Scales", 75, 1042081 );
			AddCraft( typeof( ScaledGloves ), "Scaled Plate", "scaled gloves", 62.5, 132.5, typeof( RedScales ), "Reptile Scales", 36, 1042081 );
			AddCraft( typeof( ScaledGorget ), "Scaled Plate", "scaled gorget", 59, 129, typeof( RedScales ), "Reptile Scales", 30, 1042081 );
			AddCraft( typeof( ScaledHelm ), "Scaled Plate", "scaled helm", 67.6, 137.6, typeof( RedScales ), "Reptile Scales", 45, 1042081 );
			AddCraft( typeof( ScaledLegs ), "Scaled Plate", "scaled legs", 66.3, 136.3, typeof( RedScales ), "Reptile Scales", 60, 1042081 );

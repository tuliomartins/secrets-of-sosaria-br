...
namespace Server.Items
{
	public class LevelCompositeBow : BaseLevelRanged
	{
		...
		public override int AosMinDamage{ get{ return Core.ML ?  (int)(18 * GetDamageScaling()) : (int)(20 * GetDamageScaling()); } }
		public override int AosMaxDamage{ get{ return (int)(23 * GetDamageScaling()); } }

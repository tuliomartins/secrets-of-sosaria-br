...
namespace Server.Items
{
	public class LevelCrossbow : BaseLevelRanged
	{
		...
		public override int AosMinDamage{ get{ return (int)(23 * GetDamageScaling()); } }
		public override int AosMaxDamage{ get{ return Core.ML ? (int)(27 * GetDamageScaling()) : (int)(25 * GetDamageScaling()); } }

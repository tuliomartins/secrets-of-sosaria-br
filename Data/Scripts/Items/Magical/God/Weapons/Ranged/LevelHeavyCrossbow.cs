...
namespace Server.Items
{
	...
	public class LevelHeavyCrossbow : BaseLevelRanged
	{
		...
		public override int AosMinDamage{ get{ return Core.ML ? (int)(25 * GetDamageScaling()) : (int)(24 * GetDamageScaling()); } }
		public override int AosMaxDamage{ get{ return Core.ML ? (int)(29 * GetDamageScaling()) : (int)(25 * GetDamageScaling()); } }

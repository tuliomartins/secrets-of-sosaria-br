...
namespace Server.Items
{
	public class LevelStave : BaseLevelStave
	{
		...
		public override int AosMinDamage{ get{ return Core.ML ? (int)(20 * GetDamageScaling()) : (int)(21 * GetDamageScaling()); } }
		public override int AosMaxDamage{ get{ return Core.ML ? (int)(24 * GetDamageScaling()) : (int)(23 * GetDamageScaling()); } }

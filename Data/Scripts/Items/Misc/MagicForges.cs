	...
	public class MagicForges : Item
	{
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			if ( !e.Handled )
			{
				...
				else if ( m.Region.IsPartOf( "the Tomb of Malak the Syth Lord" ) ){ keyword = "SythsMalditos"; }
				else if ( m.Region.IsPartOf( "the Tomb of Zoda the Jedi Master" ) ){ keyword = "JedisMalditos"; }

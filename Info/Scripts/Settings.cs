namespace Server
{
	...
	// public static string S_Address = "211.12.35.213";
		...
		public static string S_Address = "124.198.128.14";
	...
	public static bool S_ArtifactEnchantment = true;
	...
	// resistance categories (physical, cold, fire, poison, and energy).
		...
		public static int S_MaxResistance = 75;
	...
	// character can begin with is 10,000 gold.
		...
		public static int S_MinGold = 10000;
		public static int S_MaxGold = 10000;
	...
	// The amount of minutes before you can take a sage artifact quest after finishing one.
		...
		public static int S_GetTimeBetweenArtifactQuests = 1400;
	...
	// between 5 (low) to 100 (high).
		...
		public static int S_GetGoldCutRate = 100;
	...
	// the thief note quests you get from whispering to the guildmaster, and the decorative items they steal.
		...
		public static int S_QuestRewardModifier = 250;
	...
	// order for them to remain defeatable.
		...
		public static int S_Difficult = 3;
		public static int S_Challenging = 6;
		public static int S_Hard = 9;
		public static int S_Deadly = 12;
	...
	// This setting is the percentage to decrease the prices of items that player characters sell to vendors. Zero disables this.
		...
		public static int S_SellGoldCutRate = 0;
	...
	// the sea not used.
		...
		public static double S_BoatDecay = 5.0;
